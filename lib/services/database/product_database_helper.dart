...
import 'package:e_shop/models/Review.dart';
...
class ProductDatabaseHelper {
  ...
  Future<List> searchInProducts(String query,
  ...
  Future<String> updateUsersProduct(Product product) async {
    ...
    final productsCollectionReference =
        firestore.collection(PRODUCTS_COLLECTION_NAME);
    final docRef = productsCollectionReference.doc(product.title);
