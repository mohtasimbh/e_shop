...
import 'package:e_shop/screens/category_products/category_products_screen.dart';
import 'package:e_shop/screens/product_details/product_details_screen.dart';
import 'package:e_shop/screens/search_result/search_result_screen.dart';
...
import 'package:e_shop/services/data_streams/favourite_products_stream.dart';
                  ...
                  onSearchSubmitted: (value) async {
                    ...
                    try {
                      searchedProductsId = await ProductDatabaseHelper()
                          .searchInProducts(query.toLowerCase()) as List<String>?;
